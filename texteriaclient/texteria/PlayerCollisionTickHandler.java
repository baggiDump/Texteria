...
public class PlayerCollisionTickHandler
{
    public static void tick()
    {
        if (TexteriaOptions.playerCollisionBoxes > 0)
        {
            ...
            if (worldclient != null)
            {
                for (Entity entity : worldclient.a(entityplayersp, entityplayersp.getEntityBoundingBox(), Predicates.and(EntitySelectors.NOT_SPECTATING, (entity) ->
            {
        ...
        if (TexteriaOptions.playerCollisionVelocity == 2)
        {
            ...
            {
                for (Entity entity1 : worldclient1.a(entityplayersp1, entityplayersp1.getEntityBoundingBox().expand(0.05D, 0.0D, 0.05D), Predicates.and(EntitySelectors.NOT_SPECTATING, (entity) ->
            {
                return entity instanceof EntityOtherPlayerMP;
            })))
                {
