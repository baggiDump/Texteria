...
public class Container extends Rectangle implements IContainer
{
    ...
    private void addElement(Element2DWrapper wrapper)
    {
    ...
    public void editElement(String id, ByteMap data)
    {
        Element2D element2d = this.getElement(id);
    ...
    {
        return super.mouseWheel(delta) ? true : this.iterateHover((e) ->
        {
        ...
        if (abytemap != null)
        {
            for (ByteMap bytemap1 : abytemap)
            {
                ...
                switch (byte)
                {
                    ...
                    case 2:
                        this.editElement(bytemap1.getString("id"), bytemap1.getMap("data"));
                }
            }
