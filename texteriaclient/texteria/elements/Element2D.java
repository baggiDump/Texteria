...
public abstract class Element2D extends Element implements Element2DWrapper
{
    ...
    public Element2D(ByteMap params)
    {
        ...
        if (this.script != null)
        {
            ...
            try
            {
                ...
                Texteria.printDebug("Script for element {} eval in {} ns", new Object[] {this.id, Long.valueOf(System.nanoTime() - j)});
            }
    ...
    public void checkHover(int x, int y, long time)
    {
        ...
        if (this.hover && this.tooltip != null && !this.isIn3d)
        {
            Texteria.instance.gui.currentTooltip = this.tooltip;
        }
    }
